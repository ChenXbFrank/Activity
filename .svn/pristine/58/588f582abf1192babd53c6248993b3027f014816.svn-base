...
import com.activity.common.model.fireStorm.base.BaseFireStormRed;
 ...
 * @author ChenXb
 *
 * 2018年7月3日      FIRE_STORM_RED
 */
@SuppressWarnings("serial")
public class FireStormRed extends BaseFireStormRed<FireStormRed> {
	
	public static final FireStormRed dao = new FireStormRed();

	public FireStormRed mapping(Record cord, FireStormRed info) {
	...
	public Map<String, Object> paginate(int pageNumber, int pageSize,String activityName,String state,String startTime,String endTime,SystemUser user) {
		...
		String sql=" from FIRE_STORM_RED where 1=1 ";
		// 这里是模糊查询名字
		...
		Page<FireStormRed> page = paginate(pageNumber, pageSize, "select *", sql+" order by CREATE_TIME desc");
		for (int i = 0; i < page.getList().size(); i++) {
			Map<String, Object> model = new HashMap<String, Object>();
			FireStormRed sb = page.getList().get(i);
