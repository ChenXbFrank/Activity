package com.activity.common.model.accumulate.base;
...
public class BaseAccumulate<M extends BaseAccumulate<M>> extends Model<M> implements IBean {
	 ...
	 * 产品介绍
	 */
	public void setProductIntroduction(java.lang.String PRODUCTINTRODUCTION) {
		set("PRODUCTINTRODUCTION", PRODUCTINTRODUCTION);
	}

	public java.lang.String getProductIntroduction() {
		return get("PRODUCTINTRODUCTION");
	}
