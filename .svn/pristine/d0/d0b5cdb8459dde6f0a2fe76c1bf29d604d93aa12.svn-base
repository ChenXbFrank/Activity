...
public class BaseOneMoneyShop<M extends BaseOneMoneyShop<M>> extends Model<M> implements IBean {
	 ...
	 * 组团价
	 */
	public void setGroupMoney(java.lang.String GROUPMONEY) {
		set("GROUPMONEY", GROUPMONEY);
	}

	public java.lang.String getGroupMoney() {
		return get("GROUPMONEY");
	}
