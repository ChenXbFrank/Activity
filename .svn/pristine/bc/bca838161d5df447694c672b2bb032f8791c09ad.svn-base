...
import com.activity.common.model.robRed.base.BaseRobRed;
import com.activity.common.model.system.SystemUser;
import com.jfinal.plugin.activerecord.Page;
import com.jfinal.plugin.activerecord.Record;

@SuppressWarnings("serial")
public class RobRed extends BaseRobRed<RobRed> {
	public static final RobRed dao = new RobRed();

	public RobRed mapping(Record cord, RobRed info) {
	...
	public Map<String, Object> paginate(int pageNumber, int pageSize,String activityName,String state,String startTime,String endTime,SystemUser user) {
		...
		String sql=" from TB_ROB_RED where 1=1 ";
		// 这里是模糊查询名字
		...
		Page<RobRed> page = paginate(pageNumber, pageSize, "select *", sql+" order by CREATE_TIME desc");
		for (int i = 0; i < page.getList().size(); i++) {
			Map<String, Object> model = new HashMap<String, Object>();
			RobRed sb = page.getList().get(i);
			model.put("id", sb.getRedId());
