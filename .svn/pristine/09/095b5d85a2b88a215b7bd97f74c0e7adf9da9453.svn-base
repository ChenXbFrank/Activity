...
prompt Created on 2018年6月11日 by Administrator
set feedback off
set define off
...
insert into CPK_ORDER_INFO (id, create_time, ftype, orderortime, scannum, actualscannum, fnumber, record)
values ('7c5cd9b3417741afa1bbeb0f7be5f8fb', '2018-06-05 17:00:00', '安吉', 'CS00001', '0', '0', '0', '再次连续三次serialno=NULL-异常');
commit;
prompt 1 records loaded
