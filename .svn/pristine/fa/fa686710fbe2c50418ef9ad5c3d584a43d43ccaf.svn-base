...
import com.activity.common.model.breakEgg.base.BaseBreakEgg;
...
public class BreakEgg extends BaseBreakEgg<BreakEgg> {
	public static final BreakEgg dao = new BreakEgg();
	
//  cord.getStr("STATE")
	public BreakEgg mapping(Record cord, BreakEgg info) {
		...
		info.setBreakNumber(cord.getStr("BREAKNUMBER"));
	...
	public Map<String, Object> paginate(int pageNumber, int pageSize,String activityName,String state,String startTime,String endTime,SystemUser user) {
		...
		String sql=" from TB_BREAK_EGG where 1=1 ";
		// 这里是模糊查询名字
		...
		Page<BreakEgg> page = paginate(pageNumber, pageSize, "select *", sql+" order by CREATE_TIME desc");
		for (int i = 0; i < page.getList().size(); i++) {
			Map<String, Object> model = new HashMap<String, Object>();
			BreakEgg sb = page.getList().get(i);
