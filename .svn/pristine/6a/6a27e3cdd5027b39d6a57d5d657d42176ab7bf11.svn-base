package com.activity.common.model.robRed;
import java.util.ArrayList;
import java.util.HashMap;
import java.util.List;
import java.util.Map;

import com.activity.common.model.robRed.base.BaseRobRedWxUser;
...
public class RobRedWxUser extends BaseRobRedWxUser<RobRedWxUser>{
	public static final RobRedWxUser dao = new RobRedWxUser();
	 ...
	 * @return
	 */
	public RobRedWxUser mapping(Record cord, RobRedWxUser info) {
		info.setRedWxuserId(cord.getStr("RED_WXUSER_ID"));
	...
	public Map<String, Object> paginate1(int pageNumber, int pageSize,String activityId, String nickName) {
		...
		String sql=" from TB_ROB_RED_WXUSER t where 1=1";
		...
		Page<RobRedWxUser> page = paginate(pageNumber, pageSize, "select * ", sql+" order by t.CREATE_TIME desc");
		for (int i = 0; i < page.getList().size(); i++) {
			Map<String, Object> model = new HashMap<String, Object>();
			RobRedWxUser sb = page.getList().get(i);
			model.put("id", sb.getRedWxuserId());
