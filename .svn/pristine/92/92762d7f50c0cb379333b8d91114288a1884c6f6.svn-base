...
public class BaseScratchCardWxUserWinning<M extends BaseScratchCardWxUserWinning<M>> extends Model<M> implements IBean{

	public java.lang.String getScratchCardWxuserWinningId() {
		return get("SCRATCHCARD_WXUSER_WINNING_ID");
	}
	public void setScratchCardWxuserWinningId(java.lang.String SCRATCHCARD_WXUSER_WINNING_ID) {
		set("SCRATCHCARD_WXUSER_WINNING_ID", SCRATCHCARD_WXUSER_WINNING_ID);
	}
