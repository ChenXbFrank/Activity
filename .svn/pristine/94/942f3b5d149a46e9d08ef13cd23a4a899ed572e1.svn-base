...
public class BaseBreakEgg<M extends BaseBreakEgg<M>> extends Model<M> implements IBean {
	 ...
	 * 砸蛋次数
	 */
	public void setBreakNumber(java.lang.String BREAKNUMBER) {
		set("BREAKNUMBER", BREAKNUMBER);
	}

	public java.lang.String getBreakNumber() {
		return get("BREAKNUMBER");
	}
