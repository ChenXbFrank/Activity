...
public class BaseBreakEggWxUserWinning<M extends BaseBreakEggWxUserWinning<M>> extends Model<M> implements IBean{
	 ...
	 * @return
	 */
	public java.lang.String getBREAKEGGWxuserId() {
		return get("BREAKEGG_WXUSER_ID");
	}
	public void setBREAKEGGWxuserId(java.lang.String BREAKEGG_WXUSER_ID) {
		set("BREAKEGG_WXUSER_ID", BREAKEGG_WXUSER_ID);
	}
