...
(
  ...
  spare_one              VARCHAR2(64),
  spare_two              VARCHAR2(64),
  total_money            VARCHAR2(64),
  thanknumber            VARCHAR2(64),
  goodsnumber            VARCHAR2(64),
  total_integral         VARCHAR2(64),
  open_number            VARCHAR2(64)
)
tablespace PLSDBFLAT
  pctfree 10
  initrans 1
  maxtrans 255;
comment on column TB_OPENWINE_WXUSER.open_number
  is '开瓶次数';
...
values ('p09sw2905d3a4dcb92ery2a0324bakiu8', '开酒赢大奖', '/image/zadan-img.png', '/openWineConfig/applyOpenWine', 'openwine', '2017-11-1 13:38:07', '/openWineConfig/approveOpenWine', '/openWineConfig/openWineReport', '/openWineConfig/openWineAllActivity', null);
commit;
prompt 1 records loaded
