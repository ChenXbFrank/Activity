...
public class IndexController extends BaseController {
	...
	public void index() {
		...
		if(activitySellerInfo!=null){
			...
			//尖庄抢红包活动
			if(activitySellerInfo.getBelongActivity().equals(PropKit.use("system.properties").get("JzRed"))) {
				JzRed jzred = JzRed.dao.findById(activitySellerInfo.getActivityId());
				userCode = jzred.getAcitivityLaunchUserCode();
				...
				redirectUrl = JzRedService.getService().JzRedActivity(jzred, qrcode);
//				//外码
//				if(sign==1) {
//					
//				}else {
