package com.activity.common.model.robRed.base;
...
public class BaseRobRedPrize<M extends BaseRobRedPrize<M>> extends Model<M> implements IBean {
	public void setRedPrizeId(java.lang.String RED_PRIZE_ID) {
		set("RED_PRIZE_ID", RED_PRIZE_ID);
	}

	public java.lang.String getRedPrizeId() {
		return get("RED_PRIZE_ID");
	}
	/**
	 * 抢红包活动ID
	 * @param RED_ID
