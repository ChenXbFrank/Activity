package com.activity.common.model.jzRed.base;
...
public class BaseJzRedWxUser<M extends BaseJzRedWxUser<M>> extends Model<M> implements IBean {
	 ...
	 * @param JZ_RED_ID
	 */
	public void setJzRedId(java.lang.String JZ_RED_ID) {
		set("JZ_RED_ID", JZ_RED_ID);
	}

	public java.lang.String getJzRedId() {
		return get("JZ_RED_ID");
	}
