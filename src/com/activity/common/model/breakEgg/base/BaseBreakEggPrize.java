...
public class BaseBreakEggPrize<M extends BaseBreakEggPrize<M>> extends Model<M> implements IBean {
	 ...
	 * 所属砸蛋活动ID
	 */
	public void setEggId(java.lang.String EGG_ID) {
		set("EGG_ID", EGG_ID);
	}

	public java.lang.String getEggId() {
		return get("EGG_ID");
	}
