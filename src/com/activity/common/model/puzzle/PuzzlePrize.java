...
import com.activity.common.model.puzzle.base.BasePuzzlePrize;
...
public class PuzzlePrize extends BasePuzzlePrize<PuzzlePrize> {
	public static final PuzzlePrize dao = new PuzzlePrize();
	...
	public Map<String, Object> paginate(int pageNumber, int pageSize,String activityName,String state,String startTime,String endTime) {
		...
		String sql=" from TB_PUZZLE_PRIZE where 1=1 ";
		// 这里是模糊查询名字
		...
		Page<PuzzlePrize> page = paginate(pageNumber, pageSize, "select *", sql+" order by CREATE_TIME desc");
		for (int i = 0; i < page.getList().size(); i++) {
			Map<String, Object> model = new HashMap<String, Object>();
			PuzzlePrize sb = page.getList().get(i);
