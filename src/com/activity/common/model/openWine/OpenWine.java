...
import com.activity.common.model.openWine.base.BaseOpenWine;
...
public class OpenWine extends BaseOpenWine<OpenWine> {
	public static final OpenWine dao = new OpenWine();
	
	public OpenWine mapping(Record cord, OpenWine info) {
		...
		info.setTotalMoney(cord.getStr("TOTALMONEY"));
		return info;
	}
	...
	public Map<String, Object> paginate(int pageNumber, int pageSize,String activityName,String state,String startTime,String endTime,SystemUser user) {
		...
		String sql=" from TB_OPENWINE where 1=1 ";
		// 这里是模糊查询名字
		...
		Page<OpenWine> page = paginate(pageNumber, pageSize, "select *", sql+" order by CREATE_TIME desc");
		for (int i = 0; i < page.getList().size(); i++) {
			Map<String, Object> model = new HashMap<String, Object>();
			OpenWine sb = page.getList().get(i);
