...
public class BaseOpenWineWxUserWinning<M extends BaseOpenWineWxUserWinning<M>> extends Model<M> implements IBean{
	 ...
	 * @return
	 */
	public java.lang.String getOpenWineWxuserId() {
		return get("OPENWINE_WXUSER_ID");
	}
	public void setOpenWineWxuserId(java.lang.String OPENWINE_WXUSER_ID) {
		set("OPENWINE_WXUSER_ID", OPENWINE_WXUSER_ID);
	}
	 ...
	 * setJOIN_TYPE
	 * @author 81046
	 * @date 2018年6月21日下午4:52:07
	 * @param JOIN_TYPE
	 */
	public void setJoinType(java.lang.String JOIN_TYPE) {
		set("JOIN_TYPE", JOIN_TYPE);
	}

	public java.lang.String getJoinType() {
		return get("JOIN_TYPE");
	}
